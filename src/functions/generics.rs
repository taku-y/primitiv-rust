...
pub trait Variable:
    ...
    + ops::Add<i8, Output = Self>
    + ops::Add<u8, Output = Self>
    + ops::Add<i16, Output = Self>
    + ops::Add<u16, Output = Self>
    + ops::Add<i32, Output = Self>
    + ops::Add<u32, Output = Self>
    + ops::Add<i64, Output = Self>
    + ops::Add<u64, Output = Self>
    + ops::Add<f32, Output = Self>
    + ops::Add<f64, Output = Self>
    + ops::Sub<Self, Output = Self>
    + for<'a> ops::Sub<&'a Self, Output = Self>
    + ops::Sub<i8, Output = Self>
    + ops::Sub<u8, Output = Self>
    + ops::Sub<i16, Output = Self>
    + ops::Sub<u16, Output = Self>
    + ops::Sub<i32, Output = Self>
    + ops::Sub<u32, Output = Self>
    + ops::Sub<i64, Output = Self>
    + ops::Sub<u64, Output = Self>
    + ops::Sub<f32, Output = Self>
    + ops::Sub<f64, Output = Self>
    + ops::Mul<Self, Output = Self>
    + for<'a> ops::Mul<&'a Self, Output = Self>
    + ops::Mul<i8, Output = Self>
    + ops::Mul<u8, Output = Self>
    + ops::Mul<i16, Output = Self>
    + ops::Mul<u16, Output = Self>
    + ops::Mul<i32, Output = Self>
    + ops::Mul<u32, Output = Self>
    + ops::Mul<i64, Output = Self>
    + ops::Mul<u64, Output = Self>
    + ops::Mul<f32, Output = Self>
    + ops::Mul<f64, Output = Self>
    + ops::Div<Self, Output = Self>
    + for<'a> ops::Div<&'a Self, Output = Self>
    + ops::Div<i8, Output = Self>
    + ops::Div<u8, Output = Self>
    + ops::Div<i16, Output = Self>
    + ops::Div<u16, Output = Self>
    + ops::Div<i32, Output = Self>
    + ops::Div<u32, Output = Self>
